...
public class FishingCollectionData extends DefaultCollectionData {
    public FishingCollectionData(ArrayList<ICollectionMilestone> milestones, HashMap<Player, DefaultPlayerCollectionData> playerData) {
