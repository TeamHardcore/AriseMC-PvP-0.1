...
public class SlotUpgrade extends AbstractUpgrade {
    public SlotUpgrade(AbstractPurchaseAction action, int level, AbstractRequirement... requirements) {
        super(action, level, StringDefaults.SLOT_UPGRADE, requirements);
    }
}
